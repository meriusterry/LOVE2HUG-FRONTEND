        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-bold text-gray-800 mb-6">
              Giant Teddy Bears
              <span className="text-primary-500"> for Big Hugs</span>
            </h1>
            <p className="text-xl text-gray-600 mb-8">
              Experience the warmth of our oversized teddy bears. Perfect for gifts, 
              decorations, or cuddle buddies. Up to 6 feet tall!
            </p>
            <button
          ...
          >
            <img
              src="/images/pink-ted.jpg"
              alt="Giant Teddy Bear"
              className="rounded-3xl shadow-2xl w-half max-w-sm mx-auto animate-float"
              onError={(e) => { e.target.src = 'https://via.placeholder.com/400x400?text=Teddy+Bear'; }}
            />
          </motion.div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className={`${feature.color} w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4`}>
                {feature.icon}
              </div>
  ...
  const fetchFeaturedProducts = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        const featured = response.data.products.slice(0, 4);
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-2 mb-3">
                  <div className="flex items-center">
                    ...
                    <span className="text-gray-700 font-semibold ml-1">{parseFloat(product.rating).toFixed(1)}</span>
                  </div>
